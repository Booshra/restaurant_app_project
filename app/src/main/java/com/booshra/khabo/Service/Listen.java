package com.booshra.khabo.Service;
...
import com.booshra.khabo.OrderStatus;
...
public class Listen extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        builder.setAutoCancel(true).setDefaults(Notification.DEFAULT_ALL)
                .setWhen(System.currentTimeMillis()).setTicker("BOOSHRA")
